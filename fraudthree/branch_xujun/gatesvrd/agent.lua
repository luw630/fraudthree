...
function  Agent:init()
	...
	eventmng.add_eventbyname("EnterGameReq", "entergame")
	...
	eventmng.add_eventbyname("GetGameRoomsReq", "getgamerooms")
	eventmng.add_eventbyname("QuickStartReq", "quickstart")
	eventmng.add_eventbyname("ReadyGameReq", "readygame")
	eventmng.add_eventbyname("GetMailsReq","getmails")
	eventmng.add_eventbyname("GetmailItemsReq","getmailsitem")
